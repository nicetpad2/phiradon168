...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "run_backtest_simulation_v34", 1901),

    ("src/strategy.py", "initialize_time_series_split", 4544),
    ("src/strategy.py", "calculate_forced_entry_logic", 4547),
    ("src/strategy.py", "apply_kill_switch", 4550),
    ("src/strategy.py", "log_trade", 4553),

    ("src/strategy.py", "calculate_metrics", 3172),

    ("src/strategy.py", "aggregate_fold_results", 4556),
