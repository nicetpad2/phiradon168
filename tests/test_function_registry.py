...
FUNCTIONS_INFO = [
    ...
    ("src/features.py", "calculate_trend_zone", 1449),
    ("src/features.py", "tag_price_structure_patterns", 397),
    ("src/features.py", "create_session_column", 1456),
    ("src/features.py", "fill_missing_feature_values", 1462),
    ("src/features.py", "load_feature_config", 1467),
    ("src/features.py", "calculate_ml_features", 1472),
...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "initialize_time_series_split", 4488),
    ("src/strategy.py", "calculate_forced_entry_logic", 4491),
    ("src/strategy.py", "apply_kill_switch", 4494),
    ("src/strategy.py", "log_trade", 4497),
    ("src/strategy.py", "calculate_metrics", 3131),
    ("src/strategy.py", "aggregate_fold_results", 4500),
