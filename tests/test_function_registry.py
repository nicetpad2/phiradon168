...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 924),
    ("src/data_loader.py", "read_csv_with_date_parse", 929),
    ("src/data_loader.py", "check_nan_percent", 936),
    ("src/data_loader.py", "check_duplicates", 943),
    ("src/data_loader.py", "check_price_jumps", 950),
    ("src/data_loader.py", "convert_thai_years", 992),
    ("src/data_loader.py", "convert_thai_datetime", 999),
    ("src/data_loader.py", "prepare_datetime_index", 1027),
    ("src/data_loader.py", "load_raw_data_m1", 1082),
    ("src/data_loader.py", "load_raw_data_m15", 1092),
    ("src/data_loader.py", "write_test_file", 1098),
    ("src/data_loader.py", "validate_csv_data", 1179),
