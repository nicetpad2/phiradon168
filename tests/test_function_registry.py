...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 950),
    ("src/data_loader.py", "read_csv_with_date_parse", 955),
    ("src/data_loader.py", "check_nan_percent", 962),
    ("src/data_loader.py", "check_duplicates", 969),
    ("src/data_loader.py", "check_price_jumps", 976),
    ("src/data_loader.py", "convert_thai_years", 1018),
    ("src/data_loader.py", "convert_thai_datetime", 1025),
    ("src/data_loader.py", "prepare_datetime_index", 1053),
    ("src/data_loader.py", "load_raw_data_m1", 1108),
    ("src/data_loader.py", "load_raw_data_m15", 1118),
    ("src/data_loader.py", "write_test_file", 1124),
    ("src/data_loader.py", "validate_csv_data", 1205),
