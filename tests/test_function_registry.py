...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 997),
    ("src/data_loader.py", "read_csv_with_date_parse", 1002),
    ("src/data_loader.py", "check_nan_percent", 1009),
    ("src/data_loader.py", "check_duplicates", 1016),
    ("src/data_loader.py", "check_price_jumps", 1023),
    ("src/data_loader.py", "convert_thai_years", 1065),
    ("src/data_loader.py", "convert_thai_datetime", 1072),
    ("src/data_loader.py", "prepare_datetime_index", 1100),
