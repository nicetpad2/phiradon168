...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "run_backtest_simulation_v34", 1857),
    ("src/strategy.py", "initialize_time_series_split", 4348),
    ("src/strategy.py", "calculate_forced_entry_logic", 4351),
    ("src/strategy.py", "apply_kill_switch", 4354),
    ("src/strategy.py", "log_trade", 4357),
    ("src/strategy.py", "calculate_metrics", 3086),
    ("src/strategy.py", "aggregate_fold_results", 4360),
