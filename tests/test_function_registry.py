...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 925),
    ("src/data_loader.py", "read_csv_with_date_parse", 930),
    ("src/data_loader.py", "check_nan_percent", 937),
    ("src/data_loader.py", "check_duplicates", 944),
    ("src/data_loader.py", "check_price_jumps", 951),
    ("src/data_loader.py", "convert_thai_years", 993),
    ("src/data_loader.py", "convert_thai_datetime", 1000),
    ("src/data_loader.py", "prepare_datetime_index", 1028),
    ("src/data_loader.py", "load_raw_data_m1", 1060),
    ("src/data_loader.py", "load_raw_data_m15", 1070),
    ("src/data_loader.py", "write_test_file", 1074),
    ("src/data_loader.py", "validate_csv_data", 1155),
