...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 842),
    ("src/data_loader.py", "read_csv_with_date_parse", 847),
    ("src/data_loader.py", "check_nan_percent", 854),
    ("src/data_loader.py", "check_duplicates", 861),
    ("src/data_loader.py", "check_price_jumps", 868),
    ("src/data_loader.py", "convert_thai_years", 876),
    ("src/data_loader.py", "prepare_datetime_index", 883),
    ("src/data_loader.py", "load_raw_data_m1", 890),
    ("src/data_loader.py", "load_raw_data_m15", 895),
    ("src/data_loader.py", "write_test_file", 900),
    ("src/features.py", "calculate_trend_zone", 1176),
    ("src/features.py", "tag_price_structure_patterns", 223),
    ("src/features.py", "create_session_column", 1183),
    ("src/features.py", "fill_missing_feature_values", 1189),
    ("src/features.py", "load_feature_config", 1194),
    ("src/features.py", "calculate_ml_features", 1199),
