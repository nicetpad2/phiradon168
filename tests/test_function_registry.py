...
FUNCTIONS_INFO = [
    ...
    ("src/main.py", "load_features_from_file", 1925),
    ("src/main.py", "drop_nan_rows", 1930),
    ("src/main.py", "convert_to_float32", 1935),
    ("src/main.py", "run_initial_backtest", 1940),
    ("src/main.py", "save_final_data", 1945),
    ("src/main.py", "run_auto_threshold_stage", 1951),
