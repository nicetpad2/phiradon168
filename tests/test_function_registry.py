...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 969),
    ("src/data_loader.py", "read_csv_with_date_parse", 974),
    ("src/data_loader.py", "check_nan_percent", 981),
    ("src/data_loader.py", "check_duplicates", 988),
    ("src/data_loader.py", "check_price_jumps", 995),
    ("src/data_loader.py", "convert_thai_years", 1037),
    ("src/data_loader.py", "convert_thai_datetime", 1044),
    ("src/data_loader.py", "prepare_datetime_index", 1072),
    ("src/data_loader.py", "load_raw_data_m1", 1127),
    ("src/data_loader.py", "load_raw_data_m15", 1137),
    ("src/data_loader.py", "write_test_file", 1143),
    ("src/data_loader.py", "validate_csv_data", 1224),
