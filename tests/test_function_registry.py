...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 937),
    ("src/data_loader.py", "read_csv_with_date_parse", 942),
    ("src/data_loader.py", "check_nan_percent", 949),
    ("src/data_loader.py", "check_duplicates", 956),
    ("src/data_loader.py", "check_price_jumps", 963),
    ("src/data_loader.py", "convert_thai_years", 1005),
    ("src/data_loader.py", "convert_thai_datetime", 1012),
    ("src/data_loader.py", "prepare_datetime_index", 1040),
    ("src/data_loader.py", "load_raw_data_m1", 1095),
    ("src/data_loader.py", "load_raw_data_m15", 1105),
    ("src/data_loader.py", "write_test_file", 1111),
    ("src/data_loader.py", "validate_csv_data", 1192),
