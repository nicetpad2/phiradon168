...
FUNCTIONS_INFO = [
    ...
    ("src/strategy.py", "initialize_time_series_split", 3734),
    ("src/strategy.py", "calculate_forced_entry_logic", 3739),
    ("src/strategy.py", "apply_kill_switch", 3744),
    ("src/strategy.py", "log_trade", 3749),
    ("src/strategy.py", "calculate_metrics", 2614),
    ("src/strategy.py", "aggregate_fold_results", 3754),
