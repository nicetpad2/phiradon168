...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 935),
    ("src/data_loader.py", "read_csv_with_date_parse", 940),
    ("src/data_loader.py", "check_nan_percent", 947),
    ("src/data_loader.py", "check_duplicates", 954),
    ("src/data_loader.py", "check_price_jumps", 961),
    ("src/data_loader.py", "convert_thai_years", 1003),
    ("src/data_loader.py", "convert_thai_datetime", 1010),
    ("src/data_loader.py", "prepare_datetime_index", 1038),
    ("src/data_loader.py", "load_raw_data_m1", 1093),
    ("src/data_loader.py", "load_raw_data_m15", 1103),
    ("src/data_loader.py", "write_test_file", 1109),
    ("src/data_loader.py", "validate_csv_data", 1190),
    ...
    ("src/main.py", "parse_arguments", 1977),
    ("src/main.py", "setup_output_directory", 1982),
    ("src/main.py", "load_features_from_file", 1987),
    ("src/main.py", "drop_nan_rows", 1992),
    ("src/main.py", "convert_to_float32", 1997),
    ("src/main.py", "run_initial_backtest", 2002),
    ("src/main.py", "save_final_data", 2007),
    ("src/main.py", "run_auto_threshold_stage", 2013),
