...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "initialize_time_series_split", 4398),
    ("src/strategy.py", "calculate_forced_entry_logic", 4401),
    ("src/strategy.py", "apply_kill_switch", 4404),
    ("src/strategy.py", "log_trade", 4407),
    ("src/strategy.py", "calculate_metrics", 3090),
    ("src/strategy.py", "aggregate_fold_results", 4410),
