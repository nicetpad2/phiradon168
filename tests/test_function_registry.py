...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 931),
    ("src/data_loader.py", "read_csv_with_date_parse", 936),
    ("src/data_loader.py", "check_nan_percent", 943),
    ("src/data_loader.py", "check_duplicates", 950),
    ("src/data_loader.py", "check_price_jumps", 957),
    ("src/data_loader.py", "convert_thai_years", 999),
    ("src/data_loader.py", "convert_thai_datetime", 1006),
    ("src/data_loader.py", "prepare_datetime_index", 1034),
    ("src/data_loader.py", "load_raw_data_m1", 1066),
    ("src/data_loader.py", "load_raw_data_m15", 1076),
    ("src/data_loader.py", "write_test_file", 1080),
    ("src/data_loader.py", "validate_csv_data", 1161),
    ...
    ("src/main.py", "parse_arguments", 1968),
    ("src/main.py", "setup_output_directory", 1973),
    ("src/main.py", "load_features_from_file", 1978),
    ("src/main.py", "drop_nan_rows", 1983),
    ("src/main.py", "convert_to_float32", 1988),
    ("src/main.py", "run_initial_backtest", 1993),
    ("src/main.py", "save_final_data", 1998),
    ("src/main.py", "run_auto_threshold_stage", 2004),
