...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "initialize_time_series_split", 4061),
    ("src/strategy.py", "calculate_forced_entry_logic", 4064),
    ("src/strategy.py", "apply_kill_switch", 4067),
    ("src/strategy.py", "log_trade", 4070),
    ("src/strategy.py", "calculate_metrics", 2800),
    ("src/strategy.py", "aggregate_fold_results", 4073),
