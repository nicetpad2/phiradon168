...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 1042),
    ("src/data_loader.py", "read_csv_with_date_parse", 1047),
    ("src/data_loader.py", "check_nan_percent", 1054),
    ("src/data_loader.py", "check_duplicates", 1061),
    ("src/data_loader.py", "check_price_jumps", 1068),
