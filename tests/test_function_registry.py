...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 1014),
    ("src/data_loader.py", "read_csv_with_date_parse", 1019),
    ("src/data_loader.py", "check_nan_percent", 1026),
    ("src/data_loader.py", "check_duplicates", 1033),
    ("src/data_loader.py", "check_price_jumps", 1040),
    ("src/data_loader.py", "convert_thai_years", 1082),
    ("src/data_loader.py", "convert_thai_datetime", 1089),
    ("src/data_loader.py", "prepare_datetime_index", 1117),
    ("src/data_loader.py", "load_raw_data_m1", 1172),
    ("src/data_loader.py", "load_raw_data_m15", 1182),
    ("src/data_loader.py", "write_test_file", 1188),
    ("src/data_loader.py", "validate_csv_data", 1290),
