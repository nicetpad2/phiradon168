...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "load_raw_data_m1", 1053),
    ("src/data_loader.py", "load_raw_data_m15", 1063),
    ("src/data_loader.py", "write_test_file", 1067),
    ("src/data_loader.py", "validate_csv_data", 1148),
