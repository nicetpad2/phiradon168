...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 840),
    ("src/data_loader.py", "read_csv_with_date_parse", 845),
    ("src/data_loader.py", "check_nan_percent", 852),
    ("src/data_loader.py", "check_duplicates", 859),
    ("src/data_loader.py", "check_price_jumps", 866),
    ("src/data_loader.py", "convert_thai_years", 874),
    ("src/data_loader.py", "prepare_datetime_index", 881),
    ("src/data_loader.py", "load_raw_data_m1", 910),
    ("src/data_loader.py", "load_raw_data_m15", 921),
    ("src/data_loader.py", "write_test_file", 926),
...
# [Patch v5.5.3] Updated expected line numbers
    ...
    ("src/strategy.py", "run_backtest_simulation_v34", 1807),
    ("src/strategy.py", "initialize_time_series_split", 4235),
    ("src/strategy.py", "calculate_forced_entry_logic", 4238),
    ("src/strategy.py", "apply_kill_switch", 4241),
    ("src/strategy.py", "log_trade", 4244),
    ("src/strategy.py", "calculate_metrics", 2972),
    ("src/strategy.py", "aggregate_fold_results", 4247),
