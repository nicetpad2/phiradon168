...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "validate_csv_data", 1087),
    ...
    ("src/main.py", "parse_arguments", 1948),
    ("src/main.py", "setup_output_directory", 1953),
    ("src/main.py", "load_features_from_file", 1958),
    ("src/main.py", "drop_nan_rows", 1963),
    ("src/main.py", "convert_to_float32", 1968),
    ("src/main.py", "run_initial_backtest", 1973),
    ("src/main.py", "save_final_data", 1978),
    ("src/main.py", "run_auto_threshold_stage", 1984),
