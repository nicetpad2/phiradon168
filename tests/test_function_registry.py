...
FUNCTIONS_INFO = [
    ...
    ("src/data_loader.py", "inspect_file_exists", 918),
    ("src/data_loader.py", "read_csv_with_date_parse", 923),
    ("src/data_loader.py", "check_nan_percent", 930),
    ("src/data_loader.py", "check_duplicates", 937),
    ("src/data_loader.py", "check_price_jumps", 944),
    ("src/data_loader.py", "convert_thai_years", 986),
    ("src/data_loader.py", "convert_thai_datetime", 993),
    ("src/data_loader.py", "prepare_datetime_index", 1021),
    ("src/data_loader.py", "load_raw_data_m1", 1076),
    ("src/data_loader.py", "load_raw_data_m15", 1086),
    ("src/data_loader.py", "write_test_file", 1092),
    ("src/data_loader.py", "validate_csv_data", 1173),
